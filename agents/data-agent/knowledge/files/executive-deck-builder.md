...
a slide plan. First use the Fabric Data Agent OBO connector for at least three complementary
...
source descriptions, units, filters, and as-of dates in the code-interpreter input.
...
source details. Reopen the result and verify it contains `ppt/presentation.xml`, every
